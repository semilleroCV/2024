...
<div class="buttons">
    <a target="_blank" href="../images/proyectos_finales/papers/project2.pdf" class="button">Paper</a>
    <a target="_blank" href="https://github.com/Sneider-exe/Clasificacion_Materiales" class="button">Code</a>
</div>

     <div class="video-container" style="width:100%; height:auto;">
        <video controls autoplay muted loop style="width:100%; height:100%;">
            <source src="../images/proyectos_finales/proyecto2/arquitectura.mp4" type="video/mp4">
