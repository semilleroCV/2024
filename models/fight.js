...
directionalLight.position.set(-1.2,1,1);
directionalLight.castShadow = true;
scene.add(directionalLight);

const pointLight = new THREE.PointLight(0xff9000, 3)
scene.add(pointLight)
pointLight.position.set(1-1.2, 0, -0.7)

const pointLight2 = new THREE.PointLight(0xffffff, 2)
scene.add(pointLight2)
pointLight2.position.set(1-1.2, 0, 1.3)
...
//set pos camera
camera.position.set(-10, 20, 30); // Adjust x, y, z as needed
